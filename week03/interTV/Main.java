...
public class Main {
    public static void main(String[] args) {
        ...
        // LG TV 구현체를 조작
        // 자동 형 변환을 해서 LgTv로 만들었으나 모든 기능을 사용 가능
        MultiRemoteController mrc = new LgTv("LG"); //LgTv mrc = new LgTv("LgTv") 방식으로 객체를 인스턴스화 시키면 교체할 때 인스턴스화가 되지않음 (작은 개체 -> 큰 개체로 변하지 않음)
        mrc.turnOnOff();
        mrc.volumeUp();
        mrc.channelDown();
        mrc.channelUp();
