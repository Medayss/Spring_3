package com.study.dcinside.global.security.jwt;
...
public class JwtUtil {
    ...
    // 암호화 알고리즘
    private final SecureDigestAlgorithm<SecretKey, SecretKey> signatureAlgorithm = Jwts.SIG.HS256;
